...
import { columns } from "@/components/transaksi-jual-piutang/Columns";
import { DataTable } from "@/components/transaksi-jual-piutang/DataTable";
import PelunasanTransaksiDialogForm from "@/components/transaksi-jual-piutang/PelunasanTransaksiDialogForm";
import type { TransaksiJual } from "@/components/transaksi-jual-piutang/types";
import StrukPreviewDialog from "@/components/struk/StrukPreviewDialog";

import { debounce } from "lodash";

export default function TransaksiJualPiutangPage() {
  ...
  const fetchData = useCallback(async () => {
    try {
      setLoading(true);
      const res = await axiosInstance.get("/transaksi-jual/piutang", {
  ...
  return (
    <div className="p-4 space-y-4">
      <div>
        <h1 className="text-2xl font-bold">Catatan Hutang Pembeli</h1>
